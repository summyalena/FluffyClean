...
function Mainnav() {
  ...
  return (
        <div>
           <nav className="w-full bg-[#E1F4FC] fixed z-20 md:mb-12">
                       ...
                       {/* for the second wrapper */}
                         <div className="w-full flex items-center justify-between sm:mx-10 md:mx-20">
                             ...
                             <div className="ml-10 flex flex-shrink-0 flex-justify-center items-center py-3 px-1 ">
                                <h4 className='font-serif font-bold color-[#08374E] cursor-pointer text-green-500'>FluffyClean</h4>
                             </div>
                             ...
                             <div className="hidden md:block">
                                 ...
                                 <div className='px-2 py-3 flex space-x-4  ml-32 items-baseline items-center flex-justify-center'>
                                    <Link activeClass="imageslider" duration={100} to="imageslider" smooth={true} offset={50}
                                     ...
                                     {/* this is to show the email of the person */}
                                     
                                      {/* <li className='text-blue-400 text-sm'>{user.email}</li> 
                                     {!user && <li onClick={login} duration={100} smooth={true} offset={50}
                                     className="hover:text-white text-green-500 cursor-pointer">Login/SignUp</li> }
                                  {user && <li onClick={logout} duration={100} smooth={true} offset={50}
